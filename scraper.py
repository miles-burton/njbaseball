...
def generate_js(all_hitters, all_pitchers, all_schedules={}):
  ...
  // ── Liberty Division ───────────────────────────────────────────────────
  'West Orange':    { div:'Super Essex',      mascot:'Mountaineers', p:'#1e3a6e', s:'#4a7cc7', t:'#a8c8f0', bg:'#0a1628', logo:'https://nj.vsand-static.com/Logos/4863.png' },
  'Verona':         { div:'Super Essex',      mascot:'Hillbillies',  p:'#7a1010', s:'#a01818', t:'#d47070', bg:'#1e0505', logo:'https://nj.vsand-static.com/Logos/4742.png' },
  'Caldwell':       { div:'Super Essex',      mascot:'Chiefs',       p:'#1a35a0', s:'#2a50c8', t:'#80a8e8', bg:'#060d28', logo:'https://nj.vsand-static.com/Logos/6250.png' },
  'Nutley':         { div:'Super Essex',      mascot:'Raiders',      p:'#8b1a2a', s:'#b02535', t:'#d07080', bg:'#1a0508', logo:'https://nj.vsand-static.com/Logos/4185.png' },
  'SBP':            { div:'Super Essex',      mascot:'Gray Bees',    p:'#6b1520', s:'#8b1a28', t:'#c08088', bg:'#150508', logo:'https://nj.vsand-static.com/Logos/5380.png' },
  'MKA':            { div:'Super Essex',      mascot:'Cougars',      p:'#1a2a6b', s:'#7a6030', t:'#b09060', bg:'#07091e', logo:'https://nj.vsand-static.com/Logos/6252.png' },
  // ── American Division ──────────────────────────────────────────────────
  'SHP':            { div:'Super Essex',     mascot:'Pirates',      p:'#1a2a8b', s:'#2a50c8', t:'#8090e8', bg:'#06091e', logo:'logos/shp.png' },
  'West Essex':     { div:'Super Essex',     mascot:'Knights',      p:'#8b0a0a', s:'#b81818', t:'#e07070', bg:'#1e0505', logo:'https://nj.vsand-static.com/Logos/4855.png' },
  'Columbia':       { div:'Super Essex',     mascot:'Cougars',      p:'#0a4a1a', s:'#1a7a30', t:'#60c870', bg:'#051008', logo:'https://nj.vsand-static.com/Logos/2890.png' },
  'Livingston':     { div:'Super Essex',     mascot:'Lancers',      p:'#1a5a1a', s:'#2a8a2a', t:'#70c870', bg:'#071507', logo:'logos/livingston.png' },
  'Millburn':       { div:'Super Essex',     mascot:'Millers',      p:'#1a1a8b', s:'#3030b0', t:'#8888e0', bg:'#06061e', logo:'https://nj.vsand-static.com/Logos/3915.png' },
  'Montclair':      { div:'Super Essex',     mascot:'Mounties',     p:'#8b6914', s:'#c8960c', t:'#f0c040', bg:'#1e1500', logo:'https://nj.vsand-static.com/Logos/3939.png' },
  // ── Colonial Division ──────────────────────────────────────────────────
  'Cedar Grove':    { div:'Super Essex',     mascot:'Panthers',     p:'#1a1500', s:'#c8960c', t:'#f0c040', bg:'#0e0b00', logo:'logos/cedar-grove.png' },
  'Glen Ridge':     { div:'Super Essex',     mascot:'Ridgers',      p:'#8b1a1a', s:'#c02828', t:'#e08080', bg:'#1e0606', logo:'https://nj.vsand-static.com/Logos/3234.png' },
  'Belleville':     { div:'Super Essex',     mascot:'Buccaneers',   p:'#1a2a6b', s:'#c8960c', t:'#f0c040', bg:'#06091a', logo:'logos/belleville.png' },
  'Newark Academy': { div:'Super Essex',     mascot:'Minutemen',    p:'#6b1a1a', s:'#902828', t:'#d07070', bg:'#150606', logo:'https://nj.vsand-static.com/Logos/6253.png' },
  'Barringer':      { div:'Super Essex',     mascot:'Blue Bears',   p:'#0a2a6b', s:'#1a4aa0', t:'#6090d8', bg:'#05101e', logo:'https://nj.vsand-static.com/Logos/2623.png' },
  'Bloomfield':     { div:'Super Essex',     mascot:'Bengals',      p:'#a04010', s:'#d05818', t:'#f0a060', bg:'#200d05', logo:'https://nj.vsand-static.com/Logos/2683.png' },
  // ── Freedom Division ───────────────────────────────────────────────────
  'Shabazz':        { div:'Super Essex',      mascot:'Bulldogs',     p:'#1a1a6b', s:'#2828a8', t:'#7878e0', bg:'#06061a', logo:'https://nj.vsand-static.com/Logos/3760.png' },
  'Orange':         { div:'Super Essex',      mascot:'Tornadoes',    p:'#8b4a00', s:'#c86800', t:'#f0a030', bg:'#1e1000', logo:'https://nj.vsand-static.com/Logos/4222.png' },
  'North Star':     { div:'Super Essex',      mascot:'Cougars',      p:'#1a4a1a', s:'#2a7a2a', t:'#70c870', bg:'#061206', logo:'https://nj.vsand-static.com/Logos/6414.png' },
  'East Orange':    { div:'Super Essex',      mascot:'Jaguars',      p:'#1a6b1a', s:'#2a9a2a', t:'#70d070', bg:'#071507', logo:'https://nj.vsand-static.com/Logos/3018.png' },
  'University':     { div:'Super Essex',      mascot:'Engineers',    p:'#4a1a6b', s:'#7028a8', t:'#b878e0', bg:'#10061a', logo:'https://nj.vsand-static.com/Logos/4713.png' },
  'Weequahic':      { div:'Super Essex',      mascot:'Indians',      p:'#1a1a8b', s:'#2828b8', t:'#7878e0', bg:'#06061e', logo:'https://nj.vsand-static.com/Logos/4840.png' },
  // ── Independence Division ──────────────────────────────────────────────
  'Newark Tech':    { div:'Super Essex', mascot:'Engineers',    p:'#1a3a6e', s:'#2858a8', t:'#7098d8', bg:'#060f1e', logo:'https://nj.vsand-static.com/Logos/6318.png' },
  'Payne Tech':     { div:'Super Essex', mascot:'Panthers',     p:'#1a1a5a', s:'#2828a0', t:'#7878d8', bg:'#060614', logo:'https://nj.vsand-static.com/Logos/9906.png' },
  'East Side':      { div:'Super Essex', mascot:'Argonauts',    p:'#6b1a1a', s:'#a02828', t:'#d87070', bg:'#180606', logo:'https://nj.vsand-static.com/Logos/3019.png' },
  'Technology':     { div:'Super Essex', mascot:'Panthers',     p:'#1a1a1a', s:'#444444', t:'#cccccc', bg:'#0a0a0a', logo:'logos/technology.png' },
  'Newark Central': { div:'Super Essex', mascot:'Golden Bears', p:'#6b5000', s:'#a87800', t:'#e8c050', bg:'#181200', logo:'https://nj.vsand-static.com/Logos/2806.png' },
  'Golda Och':      { div:'Super Essex', mascot:'Royals',       p:'#4a006b', s:'#7800a8', t:'#c060e0', bg:'#100018', logo:'https://nj.vsand-static.com/Logos/6327.png' },
  ...
  'Audubon': { div:'Super Essex', mascot:'', p:'#1a2a4a', s:'#2a4a7a', t:'#8aaccc', bg:'#060d18', logo:'https://nj.vsand-static.com/Logos/2601.png' },
  ...
  'Collingswood': { div:'Super Essex', mascot:'', p:'#1a2a4a', s:'#2a4a7a', t:'#8aaccc', bg:'#060d18', logo:'https://nj.vsand-static.com/Logos/2882.png' },
  ...
  'Gloucester': { div:'Super Essex', mascot:'', p:'#1a2a4a', s:'#2a4a7a', t:'#8aaccc', bg:'#060d18', logo:'https://nj.vsand-static.com/Logos/3243.png' },
  ...
  'Haddon Heights': { div:'Super Essex', mascot:'', p:'#1a2a4a', s:'#2a4a7a', t:'#8aaccc', bg:'#060d18', logo:'https://nj.vsand-static.com/Logos/3290.png' },
  'Haddonfield': { div:'Super Essex', mascot:'', p:'#1a2a4a', s:'#2a4a7a', t:'#8aaccc', bg:'#060d18', logo:'https://nj.vsand-static.com/Logos/3292.png' },
  ...
  'Paulsboro': { div:'Super Essex', mascot:'', p:'#1a2a4a', s:'#2a4a7a', t:'#8aaccc', bg:'#060d18', logo:'https://nj.vsand-static.com/Logos/4270.png' },
  ...
  'Sterling': { div:'Super Essex', mascot:'', p:'#1a2a4a', s:'#2a4a7a', t:'#8aaccc', bg:'#060d18', logo:'https://nj.vsand-static.com/Logos/4594.png' },
  ...
  'Haddon Township': { div:'Super Essex', mascot:'', p:'#1a2a4a', s:'#2a4a7a', t:'#8aaccc', bg:'#060d18', logo:'https://nj.vsand-static.com/Logos/3291.png' },
  'West Deptford': { div:'Super Essex', mascot:'', p:'#1a2a4a', s:'#2a4a7a', t:'#8aaccc', bg:'#060d18', logo:'https://nj.vsand-static.com/Logos/4849.png' },
  ...
  'Gateway': { div:'Super Essex', mascot:'', p:'#1a2a4a', s:'#2a4a7a', t:'#8aaccc', bg:'#060d18', logo:'https://nj.vsand-static.com/Logos/3209.png' },
